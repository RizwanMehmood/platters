...
<head>
						...
						<div class="row">
							<div class="col-md-4 col-sm-4">
								...
								<div class="header-contact">
									<!-- Contact number -->
									<span><i class="fa fa-phone red"></i> 0343-4343969</span>
								</div>
							</div>
						...
						<div class="col-md-4 col-sm-5">
							...
							<a href="index.html">
								...
								<div class="logo">
									...
									<h1>Platters</h1>
									<!-- Paragraph -->
									<p>Homemade Food at your door</p>
								</div>
							</a>
						</div>
	...
	<section id="services" style="margin-bottom:-5%;">
        <div class="container">
            <div class="row">
			...
			<div class="inner-page padd">
				...
				<div class="inner-menu">
					<div class="container">
						<div class="row">
						 <div class="col-lg-12 text-center">
							<h2 class="section-heading">Our Chefs</h2>
							<hr class="primary">
						</div>	
						<?php 
